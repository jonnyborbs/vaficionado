...
![SelectSubscription](/vaficionado/assets/images/2016/11/SelectSubscription.png)  
...
![OpenDiagnosticsTenantID](/vaficionado/assets/images/2016/11/OpenDiagnosticsTenantID.png)  
...
![CreateStorageAccountAndResourceGroup](/vaficionado/assets/images/2016/11/CreateStorageAccountAndResourceGroup.png)  
...
![CreateVirtualNetwork](/vaficionado/assets/images/2016/11/CreateVirtualNetwork.png)  
...
![CreateAppRegistrationDetails](/vaficionado/assets/images/2016/11/CreateAppRegistrationDetails.png)  
...
![SetupADApp](/vaficionado/assets/images/2016/11/SetupADApp.png)Sorry the above image is a little squashed. You can always click them for larger resolution!
...
![CreateAppKey](/vaficionado/assets/images/2016/11/CreateAppKey.png)  
...
![ConfigureAPIPermissions](/vaficionado/assets/images/2016/11/ConfigureAPIPermissions.png)  
Now, look back to the left and select the **Required Permissions** option for the AD App. Click **Add** to create a new permission.

![SelectAzureSMAPI](/vaficionado/assets/images/2016/11/SelectAzureSMAPI.png)  
Click **Select an API** and choose the **Windows Azure Service Management API**, then click **Select**

![AssignSMAPIPermissions](/vaficionado/assets/images/2016/11/AssignSMAPIPermissions.png)  
...
![BackToSubscriptionsView](/vaficionado/assets/images/2016/11/BackToSubscriptionsView.png)  
...
![SelectRole1](/vaficionado/assets/images/2016/11/SelectRole1.png)  
Click **Select a Role** and choose **Contributor** from the list

![SelectUsers](/vaficionado/assets/images/2016/11/SelectUsers.png)  
...
![RolesAssigned](/vaficionado/assets/images/2016/11/RolesAssigned.png)  
...
![AzureLoginStep1](/vaficionado/assets/images/2016/11/AzureLoginStep1.png)  
...
![EnterAuthCodeStep1](/vaficionado/assets/images/2016/11/EnterAuthCodeStep1.png)  
Enter your **Auth Code** and click **Continue**

![EnterAuthCodeStep2](/vaficionado/assets/images/2016/11/EnterAuthCodeStep2.png)  
Select and log in to your Azure account…

![AuthSuccessWeb](/vaficionado/assets/images/2016/11/AuthSuccessWeb.png)

![AuthSuccessCLI](/vaficionado/assets/images/2016/11/AuthSuccessCLI.png)  
And if all went well, you now have a success message in both your browser and the CLI. Nice work!

![AzureAccountSet](/vaficionado/assets/images/2016/11/AzureAccountSet.png)  
...
![RegisterComputeProvider](/vaficionado/assets/images/2016/11/RegisterComputeProvider.png)  
...
![AzureVMImageList](/vaficionado/assets/images/2016/11/AzureVMImageList.png)  
...
![AdministrationTab](/vaficionado/assets/images/2016/11/AdministrationTab.png)  
...
![SelectAzureType](/vaficionado/assets/images/2016/11/SelectAzureType.png)  
Select the **Azure** plug-in type and click **Next**

![AzureEndpointName](/vaficionado/assets/images/2016/11/AzureEndpointName.png)  
Enter a **Name** for your Endpoint and click **Next** again

![EnterAzureSubscriptionDetails](/vaficionado/assets/images/2016/11/EnterAzureSubscriptionDetails.png)  
...
![FabricGroups](/vaficionado/assets/images/2016/11/FabricGroups.png)  
...
![NewFabricGroup](/vaficionado/assets/images/2016/11/NewFabricGroup.png)  
...
![CreateNewReservation](/vaficionado/assets/images/2016/11/CreateNewReservation.png)  
...
![NewReservationGeneral](/vaficionado/assets/images/2016/11/NewReservationGeneral.png)  
Fill in a **Name** and select a **Business Group** and **Priority** for the reservation, then click on the **Resources** tab

![NewReservationResources](/vaficionado/assets/images/2016/11/NewReservationResources.png)  
...
![NewReservationNetwork](/vaficionado/assets/images/2016/11/NewReservationNetwork.png)  
...
![CreateMachinePrefix](/vaficionado/assets/images/2016/11/CreateMachinePrefix.png)  
...
![BusinessGroups](/vaficionado/assets/images/2016/11/BusinessGroups.png)  
...
![ChooseBGMachinePrefix](/vaficionado/assets/images/2016/11/ChooseBGMachinePrefix.png)  
...
![DesignTab](/vaficionado/assets/images/2016/11/DesignTab.png)  
...
![BlueprintProperties](/vaficionado/assets/images/2016/11/BlueprintProperties.png)  
Give your blueprint a **Name** and click **OK**

![BlueprintCanvas](/vaficionado/assets/images/2016/11/BlueprintCanvas.png)  
...
![BuildInformation](/vaficionado/assets/images/2016/11/BuildInformation.png)  
...
![MachineResources](/vaficionado/assets/images/2016/11/MachineResources.png)  
...
![MachineStorage](/vaficionado/assets/images/2016/11/MachineStorage.png)  
...
![MachineNetwork](/vaficionado/assets/images/2016/11/MachineNetwork.png)  
...
![PublishBlueprint](/vaficionado/assets/images/2016/11/PublishBlueprint.png)  
...
![vRACatalog](/vaficionado/assets/images/2016/11/vRACatalog.png)  
Navigate to the **Catalog** tab, locate your new Azure blueprint and click **Request**.

![RequestDetails](/vaficionado/assets/images/2016/11/RequestDetails.png)  
...
![vRARequestStatusSuccessful](/vaficionado/assets/images/2016/11/vRARequestStatusSuccessful.png)  
You can monitor the status of the request as you normally would, in the **Requests** tab.

![vRADeployments](/vaficionado/assets/images/2016/11/vRADeployments.png)  
After the provisioning completes, you’ll be able to see your new Azure VM in vRA…

![AzureProvisioned](/vaficionado/assets/images/2016/11/AzureProvisioned.png)  
...
![SouthernTierPumking](/vaficionado/assets/images/2016/11/SouthernTierPumking-768x1024.jpg)  
