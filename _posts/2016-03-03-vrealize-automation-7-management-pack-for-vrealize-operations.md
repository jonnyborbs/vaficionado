...
![Item_Details_Before_Integration](/vaficionado/assets/images/2016/03/Item_Details_Before_Integration.png)
...
![Set_Up_Metrics_Provider](/vaficionado/assets/images/2016/03/Set_Up_Metrics_Provider.png)
...
![Accept_vROps_Cert](/vaficionado/assets/images/2016/03/Accept_vROps_Cert.png)
...
![Tenant_Machines_View](/vaficionado/assets/images/2016/03/Tenant_Machines_View.png)
...
![Item_Details_After_Integration](/vaficionado/assets/images/2016/03/Item_Details_After_Integration.png)
...
![Log_In_vRA_Default_Administrator](/vaficionado/assets/images/2016/03/Log_In_vRA_Default_Administrator.png)
...
![Locate_Target_Tenant](/vaficionado/assets/images/2016/03/Locate_Target_Tenant.png)
...
![Add_New_Local_User](/vaficionado/assets/images/2016/03/Add_New_Local_User.png)
...
![Assign_Tenant_Rights](/vaficionado/assets/images/2016/03/Assign_Tenant_Rights.png)

Now you’ll need to log back in as your normal vRA **Tenant Administrator** to finish the configuration.

![Log_In_vRA_Tenant_Admin](/vaficionado/assets/images/2016/03/Log_In_vRA_Tenant_Admin.png)
...
![Navigate_To_Fabric_Groups](/vaficionado/assets/images/2016/03/Navigate_To_Fabric_Groups.png)
...
![Edit_Fabric_Group](/vaficionado/assets/images/2016/03/Edit_Fabric_Group.png)
...
![Navigate_To_Directory_Users](/vaficionado/assets/images/2016/03/Navigate_To_Directory_Users.png)
...
![Assign_Software_Architect_Role](/vaficionado/assets/images/2016/03/Assign_Software_Architect_Role.png)
...
![Log_In_vROps](/vaficionado/assets/images/2016/03/Log_In_vROps.png)

Click on the **Administration** tab, and ensure **Solutions** is selected. Click the **+** symbol to import a new Solution.

![Import_New_Solution](/vaficionado/assets/images/2016/03/Import_New_Solution.png)
...
![Upload_New_Solution](/vaficionado/assets/images/2016/03/Upload_New_Solution.png)

Accept the EULA (after reading it carefully first, of course) and click **Next** again.

![Accept_EULA](/vaficionado/assets/images/2016/03/Accept_EULA.png)

The installation will run for a while. When it shows “Completed”, click **Finish**.

![Complete_Installation](/vaficionado/assets/images/2016/03/Complete_Installation.png)
...
![Configure_Solution_Basics](/vaficionado/assets/images/2016/03/Configure_Solution_Basics.png)
...
![Manage_Credential](/vaficionado/assets/images/2016/03/Manage_Credential.png)
...
![Test_Connection_Accept_Cert_1](/vaficionado/assets/images/2016/03/Test_Connection_Accept_Cert_1.png)

![Accept_Cert_2](/vaficionado/assets/images/2016/03/Accept_Cert_2.png)

If you’ve set everything up properly, you’ll see a message like this one. Click **OK**.

![Test_Successful](/vaficionado/assets/images/2016/03/Test_Successful.png)
...
![Save_Solution_Settings](/vaficionado/assets/images/2016/03/Save_Solution_Settings.png)
...
![Solution_Details](/vaficionado/assets/images/2016/03/Solution_Details.png)
...
![Navigate_To_vRA_Dashboards](/vaficionado/assets/images/2016/03/Navigate_To_vRA_Dashboards.png)
...
![vRealize_Automation_Overview](/vaficionado/assets/images/2016/03/vRealize_Automation_Overview.png)
...
![vR_Automation_Tenant_Overview](/vaficionado/assets/images/2016/03/vR_Automation_Tenant_Overview.png)
...
![vR_Automation_Cloud_Infrastructure_Monitoring](/vaficionado/assets/images/2016/03/vR_Automation_Cloud_Infrastructure_Monitoring.png)
...
![vR_Automation_Top-N_Dashboard](/vaficionado/assets/images/2016/03/vR_Automation_Top-N_Dashboard.png)
...
![vRealize_Automation_Environment](/vaficionado/assets/images/2016/03/vRealize_Automation_Environment.png)
