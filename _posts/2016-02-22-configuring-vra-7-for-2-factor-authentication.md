...
![Create_DNS_Record](/assets/images/2016/02/Create_DNS_Record.png)
...
![Log_In_Host_SSH](/assets/images/2016/02/Log_In_Host_SSH.png)
...
![Edit_SELinux_Configuration](/assets/images/2016/02/Edit_SELinux_Configuration.png)
...
![Install_Configure_NTP](/assets/images/2016/02/Install_Configure_NTP.png)
...
![Confirm_DNS_Config](/assets/images/2016/02/Confirm_DNS_Config.png)
...
![Install_wget](/assets/images/2016/02/Install_wget.png)
...
![Install_PBIS](/assets/images/2016/02/Install_PBIS.png)
...
![Join_AD_Domain](/assets/images/2016/02/Join_AD_Domain.png)
...
![Validate_Domain_Membership](/assets/images/2016/02/Validate_Domain_Membership.png)
...
![Create_Denied_Logon_Group](/assets/images/2016/02/Create_Denied_Logon_Group.png)
...
![Prepare_RPMforge_Repo](/assets/images/2016/02/Prepare_RPMforge_Repo.png)
...
![Install_Build_Tools](/assets/images/2016/02/Install_Build_Tools.png)
...
![Download_Compile_Google_Authenticator](/assets/images/2016/02/Download_Compile_Google_Authenticator.png)
...
![Install_FreeRADIUS](/assets/images/2016/02/Install_FreeRADIUS.png)
...
![Change_FreeRADIUS_User_Group](/assets/images/2016/02/Change_FreeRADIUS_User_Group.png)
...
![Configure_Denied_RADIUS_Users](/assets/images/2016/02/Configure_Denied_RADIUS_Users.png)
...
![Enable_RADIUS_PAM](/assets/images/2016/02/Enable_RADIUS_PAM.png)
...
![Configure_PAM_Modules](/assets/images/2016/02/Configure_PAM_Modules.png)
...
![Add_RADIUS_Site](/assets/images/2016/02/Add_RADIUS_Site.png)
...
![Restart_radiusd](/assets/images/2016/02/Restart_radiusd.png)
...
![Configure_vRA_Directory_Connector](/assets/images/2016/02/Configure_vRA_Directory_Connector.png)
...
![Configure_Auth_Adapters](/assets/images/2016/02/Configure_Auth_Adapters.png)
...
![Configure_RADIUS_Adapter](/assets/images/2016/02/Configure_RADIUS_Adapter.png)
...
![vRA_Network_Ranges](/assets/images/2016/02/vRA_Network_Ranges.png)
...
![Add_Network_Range](/assets/images/2016/02/Add_Network_Range.png)
...
![vRA_Access_Policies](/assets/images/2016/02/vRA_Access_Policies.png)

Click on the **Green +** sign to add a new policy rule.

![Edit_Default_Policy](/assets/images/2016/02/Edit_Default_Policy.png)
...
![Add_Policy_Rule](/assets/images/2016/02/Add_Policy_Rule.png)

Now, grab the icon highlighted in red with your mouse and drag the new rule to the top of the list. Click **Save**.

![Reorder_Policy_Rules](/assets/images/2016/02/Reorder_Policy_Rules.png)
...
![Su_to_AD_User](/assets/images/2016/02/Su_to_AD_User.png)
...
![Create_Google_Authenticator_Token](/assets/images/2016/02/Create_Google_Authenticator_Token.png)
...
![Google_Authenticator_App_Store](/assets/images/2016/02/Google_Authenticator_App_Store.png)
...
![Set_Up_Google_Authenticator](/assets/images/2016/02/Set_Up_Google_Authenticator.png)

Point your phone at the QR code generated on the screen and the app will do the rest!

![Scan_QR_Code](/assets/images/2016/02/Scan_QR_Code.png)
...
![View_User_Token](/assets/images/2016/02/View_User_Token.png)
...
![Login_vRA](/assets/images/2016/02/Login_vRA.png)
...
![Login_Successful](/assets/images/2016/02/Login_Successful.png)
...
![Breakside_Salted_Caramel](/assets/images/2016/02/Breakside_Salted_Caramel.jpg)
